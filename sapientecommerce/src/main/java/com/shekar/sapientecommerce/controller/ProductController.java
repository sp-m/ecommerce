package com.shekar.sapientecommerce.controller;
...
import com.shekar.sapientecommerce.service.ProductService;
...
public class ProductController {
	...
	public ResponseEntity<List<Product>> findGroupByBrand(@PathVariable String brand) {
		List<Product> list = productService.findGroupByBrand(brand);
		return new ResponseEntity<List<Product>>(list, HttpStatus.OK);
	}

	@GetMapping("/product/color/{color}")
	public ResponseEntity<List<Product>> findGroupByColor(@PathVariable String color) {
		List<Product> list = productService.findGroupByColor(color);
		return new ResponseEntity<List<Product>>(list, HttpStatus.OK);
	}

	@GetMapping("/product/size/{size}")
	public ResponseEntity<List<Product>> findGroupBySize(@PathVariable String size) {
		List<Product> list = productService.findGroupBysize(size);
		return new ResponseEntity<List<Product>>(list, HttpStatus.OK);
	}

	@GetMapping("/product/price/{price}")
	public ResponseEntity<List<Product>> findGroupByPrice(@PathVariable double price) {
